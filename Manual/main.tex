...
GAME: \\
Tutorial and Language Reference Manual\par % Book title
\vspace*{1cm}
{\Huge Team 13}\par % Author name
\endgroup
%image source:http://www.flickr.com/photos/30062916@N03/5856012572/in/photolist-9VtAw1-9VqJDv-eX7UT3-97Wphz-bGYqGr-9mz3tP-bPYVZH-bPYUZi-bPYW8k-aquTpX-edHowu-edHhmf-edHhsj-edBJcH-edHhQ3-edBHGr-edBCcF-edHoi9-edBHSF-edHhYd-8h2aRU-9ge33N-dpQ9KG-bQxYAP-eUTD7v-dpQc8u-dpQatA-brsw4X-aoUFgG-8xoMcp-jqt5ud-gKgagT-86QTP3-dgvHtj-ccNMYU-eiNJLw-cXEFHo-7MBNMm-jB9nyg-bA1auz-8TB5h3-eEP4YW-jjYKCF-cx4NxW-fkFgrf-frqA8H-kZhMQp-a6DokH-a6G9SQ-a6DN2Z-a6GFN5
...
\noindent Copyright \copyright\ 2014 Dylan Hicks, Theo Marin, William McAuliff, James Wen, Sean Wong\\ % Copyright notice
...
\noindent \textit{First printing, March 2014} % Printing/edition date

%----------------------------------------------------------------------------------------
%	TABLE OF CONTENTS
%----------------------------------------------------------------------------------------

\chapterimage{main.png} % Table of contents heading image
...
\begin{lstlisting}[label=first-program,caption=First Program]
Print the words
	hello, world
\end{lstlisting}
...
\begin{lstlisting}[label=hello-world,caption=HelloWorld.GAME]
#include stdlib.game
...
\end{lstlisting}
A GAME program consists of functions and variables. A function contains statements that specify the computing operations to be done and variables store values used during computation. In the above example, main is the function. Functions can typically be named by the user, but main is different because the program is executed inside of it. main normally calls other functions -- some written by the user and others by libraries already present in the system.
\section{Variables and Arithmetic Expressions}\index{Variables and Arithmetic Expressions}
\section{The For Loop}\index{The For Loop}
\section{Lists}\index{Lists}
\section{Functions}\index{Functions}
\section{Classes}\index{Classes}
\section{Major Standard Library Methods/ Classes}\index{Major Standard Library Methods/ Classes}
\section{File Reading (and writing)}\index{File Reading (and writing)}
\section{Advanced Features}\index{Advanced Features}
\section{Clarification}\index{Clarification}
...
\section{Lexical Conventions}\index{Lexical Conventions}

\subsection{Tokens}\index{Lexical Conventions!Tokens}

\subsection{Comments}\index{Lexical Conventions!Comments}
